...
describe('midi.input', function() {
  ...
  describe('.openPort', function() {
    ...
    it('should return true if not already open', function() {
      input.openPort(0).should.eql(true);
    });

    it('should return false if already open', function() {
      input.openPort(0).should.eql(false);
    });
  });
  ...
  describe('.openVirtualPort', function() {
    ...
    it('should return true if not already open', function() {
      input.openVirtualPort("test").should.eql(true);
    });

    it('should return false if already open', function() {
      input.openVirtualPort("test").should.eql(false);
    });
  });
  ...
  describe('.closePort', function() {
    ...
    it('should return true if not already closed for openPort()', function() {
      input.openPort(0);
      input.closePort().should.eql(true);
    });

    it('should return false if already closed for openPort()', function() {
      input.closePort().should.eql(false);
    });
  ...
  describe('.isPortOpen', function() {
    ...
    it('should return true if port open for openPort()', function() {
      input.openPort(0);
      input.isPortOpen().should.eql(true);
    });

    it('should return false if port closed for openPort()', function() {
      input.closePort();
      input.isPortOpen().should.eql(false);
    });
...
describe('midi.output', function() {
  ...
  describe('.openPort', function() {
    ...
    it('should return true if not already open', function() {
      output.openPort(0).should.eql(true);
    });

    it('should return false if already open', function() {
      output.openPort(0).should.eql(false);
    });
  });
  ...
  describe('.openVirtualPort', function() {
    ...
    it('should return true if not already open', function() {
      output.openVirtualPort("test").should.eql(true);
    });

    it('should return false if already open', function() {
      output.openVirtualPort("test").should.eql(false);
    });
  });
  ...
  describe('.closePort', function() {
    ...
    it('should return true if not already closed for openPort()', function() {
      output.openPort(0);
      output.closePort().should.eql(true);
    });

    it('should return false if already closed for openPort()', function() {
      output.closePort().should.eql(false);
    });
  ...
  describe('.isPortOpen', function() {
    ...
    it('should return true if port open for openPort()', function() {
      output.openPort(0);
      output.isPortOpen().should.eql(true);
    });

    it('should return false if port closed for openPort()', function() {
      output.closePort();
      output.isPortOpen().should.eql(false);
    });
